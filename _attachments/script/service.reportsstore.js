...
(function(acralyzerConfig,angular,acralyzerEvents,acralyzer,hex_md5,Showdown) {
    ...
    acralyzer.factory('ReportsStore', ['$rootScope', '$http', '$resource', function($rootScope, $http, $resource) {
        ...
        */
        ...
        ReportsStore.appNamesList = function(cb) {
            return ReportsStore.views.get({view: 'recent-items-by-appname', group_level: 1}, cb);
        };
        ...
        ReportsStore.LevelList = function(cb) {
            return ReportsStore.views.get({view: 'recent-items-by-level', group_level: 1}, cb);
        };
