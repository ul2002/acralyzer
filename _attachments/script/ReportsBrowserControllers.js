    ...
    function ReportsBrowserCtrl($scope, ReportsStore, $routeParams) {
        ...
        $scope.changeFilterValues = function() {
            ...
            if($scope.filterName === $scope.noFilter) {
                ...
                if($scope.filterName.value === "level") {
                    getFilteredValues = ReportsStore.LevelList;
                } else if ($scope.filterName.value === "appname") {
                    getFilteredValues = ReportsStore.appNamesList;
                }
